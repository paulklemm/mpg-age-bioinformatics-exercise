...
*This solution relies on the `ibb` package, which is not available via CRAN or Github. Therefore, it has to be installed manually. Please follow the instructions on the [package website](http://www.oncoproteomics.nl/software/BetaBinomial.html). Other required packages are managed using [Packrat](https://rstudio.github.io/packrat/).*
